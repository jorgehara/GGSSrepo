                                                  ...
                                                  <div className="row row-cols-12">
                                                    <div className="segunda__columna col-xl-4">
                                                      ...
                                                      <InputForm
                                                        value={
                                                          valueempl
                                                            ? formDatosPersonales?.apellidoInput
                                                      ...
                                                      <InputForm
                                                        value={
                                                          valueempl
                                                            ? formDatosPersonales?.nombresInput
                                                            : empleadoUno.nombres
                                                        }
                                                      ...
                                                      <DNICboBox
                                                        value={
                                                          valueempl
                                                            ? formDatosPersonales?.documentoInput
                                                        ...
                                                        array={
                                                          datosPersonalesState.tiposDocumento &&
                                                          datosPersonalesState.tiposDocumento !== ""
                                                            ? datosPersonalesState.tiposDocumento
                                                            : ["no entro"]
                                                        }
                                                        ...
                                                        idSelected={
                                                          formDatosPersonales?.dniSelected &&
                                                          formDatosPersonales?.dniSelected !== ""
                                                            ? formDatosPersonales?.dniSelected &&
                                                              formDatosPersonales?.dniSelected
                                                      ...
                                                      <InputForm
                                                        value={
                                                          valueempl
                                                            ? formDatosPersonales?.telefonoInput
                                                            : empleadoUno.telFijo
                                                        }
                                                        action={ADD_DATOS_PERSONALES}
                                                      ...
                                                      <InputCbo
                                                        ...
                                                        array={
                                                          datosPersonalesState.estadosCiviles &&
                                                          datosPersonalesState.estadosCiviles &&
                                                          datosPersonalesState.estadosCiviles !== ""
                                                            ? datosPersonalesState.estadosCiviles
                                                            : ["no entro"]
                                                        ...
                                                        idSelected={
                                                          formDatosPersonales?.estadoCivilInput
                                                            ? formDatosPersonales?.estadoCivilInput
                                                            : empleadoUno.iDestadoCivil
                                                        }
                                                      ...
                                                      <InputCbo
                                                        ...
                                                        array={
                                                          datosPersonalesState.paises !== undefined &&
                                                          datosPersonalesState.paises !== ""
                                                            ? datosPersonalesState.paises
                                                            : ["Nacionalidad"]
                                                        }
                                                        ...
                                                        idSelected={
                                                          formDatosPersonales?.nacionalidadesInput
                                                            ? formDatosPersonales?.nacionalidadesInput
                                                            : empleadoUno.iDnacionalidad
                                                        }
                                                        valueId="idPais"
                                                    ...
                                                    <div className="tercera_columna col-xl-4">
                                                      <InputCbo
                                                        ...
                                                        nameLabel="Estado"
                                                        array={
                                                          datosPersonalesState.estados !== undefined &&
                                                          datosPersonalesState.estados !== ""
                                                            ? datosPersonalesState.estados
                                                            : []
                                                        }
                                                        ...
                                                        idSelected={
                                                          formDatosPersonales?.estadosEmpleados
                                                            ? formDatosPersonales?.estadosEmpleados
                                                            : empleadoUno.idEstado
                                                        }
                                                        valueId="idEstado"
                                                      ...
                                                      <InputDate
                                                        value={
                                                          formDatosPersonales?.inputDateNac
                                                            ? formDatosPersonales?.inputDateNac
                                                            : empleadoUno?.fechaNacimiento?.substring(
                                                                0,
                                                                empleadoUno.fechaNacimiento.length - 9
                                                              )
                                                        }
                                                        action={ADD_DATOS_PERSONALES}
                                                      ...
                                                      <InputCbo
                                                        ...
                                                        idSelected={
                                                          formDatosPersonales?.paisOrigenInput
                                                            ? formDatosPersonales?.paisOrigenInput
                                                      ...
                                                      <InputCbo
                                                        value={
                                                          formDatosPersonales?.estudiosInput
                                                            ? formDatosPersonales?.estudiosInput
                                                        ...
                                                        nameLabel="Estudios"
                                                        array={
                                                          datosPersonalesState.estudios !== undefined &&
                                                          datosPersonalesState.estudios !== ""
                                                            ? datosPersonalesState.estudios
                                                            : []
                                                        }
                                                      ...
                                                      <TextArea
                                                        ...
                                                        maxLength="255"
                                                        value={
                                                          formDatosPersonales?.observacionesEstudios
                                                            ? formDatosPersonales?.observacionesEstudios
