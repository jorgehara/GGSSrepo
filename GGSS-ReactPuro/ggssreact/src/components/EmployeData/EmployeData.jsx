        ...
        <div className='container mt-2 border border-3 p-3'>
            <div className='row'>
                ...
                <div className='col-xl-6 ml-4'>
                    ...
                    <InputEmpData idInput="apellidoInfo" inputValue={saveEmpl[0] !== undefined || saveEmpl[0] === null ? saveEmpl[0].apellido : null} nameLabel="Apellido: " />
                    <InputEmpData idInput="nombresInfo" inputValue={saveEmpl[0] !== undefined || saveEmpl[0] === null ? saveEmpl[0].nombres : null} nameLabel="Nombres: " />
                    <InputEmpData idInput="tipoDNIInfo" inputValue={saveEmpl[0] !== undefined || saveEmpl[0] === null ? saveEmpl[0].nroDocumento : null} nameLabel="Nro Documento: " />
                </div>
                <div className='col-xl-3'>
                    <InputEmpData idInput="estadoInfo" inputValue={saveEmpl[0] !== undefined || saveEmpl[0] === null ? saveEmpl[0].estado : "Sin Estado"} nameLabel="Estado: " />
                </div>
            </div>
        </div>
    </div>
