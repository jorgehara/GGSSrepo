...
import DNICboBox from '../DNICboBox/DNICboBox'
import InputRadio from '../InputRadio/InputRadio'
import "./InputMultiple.css"

const InputMultiple = ({valueDNI, nameInputDNI, optionsDNI, valueRadio,nameFirst,nameSecond, nameInputRadio, placeholder }) => {
    ...
    return(
        <div className='container-flex align-items-center'>
            <div className="formulario__grupo mt-2">
                <div className="">
                    <label class="formulario-label-DNI mt-2">{nameInputDNI}</label>
                </div> 
                <div className=''>
                ...
                <div className="formulario__grupo__inputs__radio">
                    <div className='form__grupo__label'>
                        <label className='form__grupo__label__label'  htmlFor="legajo">{nameInputRadio}</label>
                    </div>
                    <div className="form-check form-check-inline">
                    <input className="form-check-input" type="radio" id="inlineCheckbox1" name={nameInputRadio} checked={valorRadioM} onChange={(e)=> setValorRadioM(e.target.value)} value={valorRadioM}/>
                    <label className="form-check-label" htmlFor="inlineCheckbox1">{nameFirst}</label>
                    </div>
                    <div className="form-check form-check-inline">
                    <input className="form-check-input" type="radio" id="inlineCheckbox2" name={nameInputRadio} checked={valorRadioF} onChange={(e)=> setValorRadioF(e.target.value)} value={valorRadioF}/>
