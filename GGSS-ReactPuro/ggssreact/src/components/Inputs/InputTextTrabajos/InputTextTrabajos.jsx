  ...
  return (
    <>
        <div className='col-xl-6 d-flex flex-row justify-content-start align-items-center mt-2'>
            ...
            <input disabled={disable} type="text" name={inputId} id={inputId} onChange={(e)=> onChange(e.target.value, inputId)} value={value && value} className="textTrabajos formulario-input-TextTrabajo"/>        
        </div>
