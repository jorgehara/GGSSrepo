...
const InputButton = ({nameButton, placeholder, nameLabel, value}) => {
  return (
    <div className="formulario__grupo__inputs">
        ...
        <div className='form__grupo__input'>
            <input type="text" class="form__grupo__input" value={value} placeholder={placeholder} id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" />
        </div>
