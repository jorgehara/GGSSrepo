      ...
      {idCategory === "estudios" && (
        <>
          ...
          <BasicModal
            idModal="Estudios"
            nameModal="Estudios"
            nameOptionModal="Nivel de Estudios"
          />
        </>
      )}
      ...
      {idCategory === "tipoDocumento" && (
        <>
          ...
          <BasicModal
            ...
            nameOptionModal="Tipo de Documento"
          />
        </>
      )}
      ...
      {idCategory === "modosDeContratacion" && (
        <>
          ...
          <ModalSelectDateObs
            ...
            nameOptionModal="Modos de Contratación"
          />
        </>
      )}
      ...
      {idCategory === "modosDeLiquidacion" && (
        <>
          ...
          <BasicModalSelectObs
            ...
            nameOptionModal="Modos de Liquidacion"
          />
        </>
      )}
      ...
      {idCategory === "motivosEgreso" && (
        <>
          ...
          <BasicModalObs
            ...
            nameOptionModal="Motivo de egreso"
          />
        </>
      )}
