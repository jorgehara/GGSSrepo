...
const Familia = () => {
  ...
  const columns = ["Nombre Apellido", "Tipo/N° DNI" , "Parentesco", "Nacimiento", "Pais Origen", "Nacionalidad", "Estudios", "Fecha Baja", "Obs"]
  return (
    <div className='container'>
                ...
                <div className='col-xl-6'>  
                  <div className='container-flex'>
                    <div className='container mt-2'>
                        ...
                        <InputParentesco nameInput="Parentesco" array={parentesco} placeHolder="Parentesco" nameButton="..." nameCheck="Fijar" checked="" display={true}/>
        ...
        <div className='col-xl-6'>
                  <InputParentesco nameInput="Estudios" array={paises} placeHolder="Estudios" nameButton="..." nameCheck="Fijar" checked="" display={true}/>
                  <InputDate value={saveEmpl[0] !== undefined ? saveEmpl[0].fechaNacimiento : null} display={true} checked={false} nameInput="Fecha Baja"/>
