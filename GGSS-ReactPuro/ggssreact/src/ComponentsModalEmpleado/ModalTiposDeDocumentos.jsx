...
const ModalTiposDeDocumentos = () => {
  return (
    <div>
        {/* <!-- Button trigger modal --> */}
       <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Modal Tipos de Documentos
      </button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="bodyInputs">
                  ...
                  <label for="tipoDocumento" style={{marginRight: "15px"}}>Tipo de documento: </label>
...
export default ModalTiposDeDocumentos