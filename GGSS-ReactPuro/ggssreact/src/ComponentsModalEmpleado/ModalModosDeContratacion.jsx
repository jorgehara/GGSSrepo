...
const ModalModosDeContratacion = () => {
  return (
    <div>
        {/* <!-- Button trigger modal --> */}
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Modal Modos de Contratacion
            </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="bodyInputs">
                                ...
                                <label for="modo" style={{ marginRight: "15px" }}> Modo de contratación: </label>
                                ...
                                <label for="vencimiento" style={{ marginRight: "7px" }}>Vencimiento: </label>
                                <input type="date" />
...
export default ModalModosDeContratacion