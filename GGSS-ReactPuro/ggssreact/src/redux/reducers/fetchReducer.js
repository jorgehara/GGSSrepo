...
export const fetchReducer = (state = initialState, action) =>{
    switch(action.type){
        ...
        case GET_ID_MODOCONT : {
            return {
                ...state,
                idModoCont: action.payload
            }
        }
        case DELETE_MODOCONT : {
            return {
                ...state,
