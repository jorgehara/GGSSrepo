...
const validationsForm = (form) => {
  ...
  if (!form.name.trim()) { //sino tiene nombre escrito, es decir esta vacío, se ACTIVA el Error
    errors.name = "El campo 'País de Origen' es requerido";
  } else if (!regexName.test(form.name.trim())) {
    errors.name = "El campo 'País de Origen' sólo acepta letras, sin espacios en blanco";
  }
...
{/* //ES un CONDICIONAL para que se MUESTRE EL ERROR debajo del formulario */}
       ...
       <input type="submit" value="..." 
        ...
        class="btn btn-validacion btn-outline-primary"
